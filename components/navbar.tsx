    ...
    return (
        <nav className="fixed top-0 flex w-full pb-12 max-h-[66px] bg-white shadow-sm text-center">
            <div className="mx-[25px] my-[18px] pr-24">
                <Link href="https://youtu.be/xvFZjo5PgG0?si=BnbvMVhfynKkNWpz" className=" ">
                    <Image
                        src="/notion-icon.svg"
                        alt="notion logo"
                        width={42}
            ...
            <div className="flex-row w-full h-full max-h-[66px] text-black font-[505] text-center items-center text-sm py-6 pl-40">
                <Link href="https://youtu.be/xvFZjo5PgG0?si=BnbvMVhfynKkNWpz" className="mr-3">
                    Notion
                </Link>
                <Link href="https://youtu.be/xvFZjo5PgG0?si=BnbvMVhfynKkNWpz" className="m-3">
                    Mail
                </Link>
                <Link href="https://youtu.be/xvFZjo5PgG0?si=BnbvMVhfynKkNWpz" className="m-3">
                    Calendar
            ...
            <div className="flex mt-3.5 items-end w-[450px] h-full pl-6">
                <Link href="https://youtu.be/xvFZjo5PgG0?si=BnbvMVhfynKkNWpz" className=" text-[15px] text-black h-max-[66px] max-w-2xl mr-5 mb-2">
                    Log in
                </Link>
                <Link
